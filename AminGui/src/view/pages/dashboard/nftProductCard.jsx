...
export default function NFTProductCard() {
    ...
    return (
        <Card
            className="hp-border-radius-xxl hp-overflow-hidden hp-border-1 hp-border-color-black-40 hp-border-color-dark-80">
            <Row gutter={[20, 0]}>
                <Col md={11} span={24}>
                    <div
                        ...
                        <Col>
                            <Row align="middle" className="hp-mb-24">
                                ...
                                <Col>
                                    ...
                                    <span
                                        className="hp-d-block hp-p1-body hp-font-weight-500 hp-text-color-black-100 hp-text-color-dark-0">Daniel Malbrook</span>
                                </Col>
                            </Row>
                ...
                ></span>
                                ...
                                <Row justify="space-between">
                                    <Col>
                                        <span
                                            className="hp-p1-body hp-font-weight-500 hp-text-color-black-80 hp-text-color-dark-30">Current <br/> Bid</span>
                                    </Col>
                  ...
                  0.00050 ETH
                                        ...
                                        <span
                                            className="hp-d-block hp-input-description hp-font-weight-500 hp-text-color-black-60"
                                            style={{marginLeft: 26}}>$1,732.23</span>
                                    </Col>
                                </Row>
                            </div>
                ...
                ></span>
                                ...
                                <Row justify="space-between">
                                    <Col>
                                        <span
                                            className="hp-p1-body hp-font-weight-500 hp-text-color-black-80 hp-text-color-dark-30">Auction <br/> Ending In</span>
                                    </Col>
                                    ...
                                    <Col>
                                        <Row>
                                            <Col>
                                                <span
                                                    className="h4 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mb-8">00</span>
                                                <span
                                                    className="hp-d-block hp-badge-text hp-font-weight-500 hp-text-color-black-60">Hours</span>
                                            </Col>

                                            <Col><span
                                                className="hp-d-block h4 hp-text-color-black-100 hp-text-color-dark-20 hp-mx-6">:</span></Col>

                                            <Col>
                                                <span
                                                    className="h4 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mb-8">56</span>
                                                <span
                                                    className="hp-d-block hp-badge-text hp-font-weight-500 hp-text-color-black-60">Mins</span>
                                            </Col>
                                            ...
                                            <Col>
                                                <span
                                                    className="h4 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mb-8">24</span>
                                                <span
                                                    className="hp-d-block hp-badge-text hp-font-weight-500 hp-text-color-black-60">Secs</span>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                            ...
                            <Row gutter={[16, 16]} className="hp-mt-16">
                                ...
                                <Col span={12}>
                                    <Button type="primary" block ghost className="hp-border-radius-full">View
                                        Art</Button>
                                </Col>
                            </Row>
                        </Col>
