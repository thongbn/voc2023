                ...
                <Col>
                    <Row>
                        <Col className="hp-pr-64 hp-pr-sm-16">
                            <span
                                className="hp-d-block hp-w-100 hp-caption hp-text-color-black-80 hp-text-color-dark-20">Current bid</span>

                            <div className="hp-d-flex-center hp-mb-4">
                                <span
                                    className="h5 hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-font-weight-500 hp-mr-6">0.00050 ETH</span>
                        ...
                        <Col>
                            <span
                                className="hp-d-block hp-w-100 hp-caption hp-text-color-black-80 hp-text-color-dark-20 hp-mb-4">Auction Ending In</span>
