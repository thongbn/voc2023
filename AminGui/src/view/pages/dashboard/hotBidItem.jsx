...
export default function HotBidItem(props) {
    ...
    return (
        <div
            className="hp-border-radius-xxl hp-bg-black-0 hp-bg-dark-100 hp-border-1 hp-border-color-black-40 hp-border-color-dark-80 hp-p-16">
            ...
            <Row align="bottom" justify="space-between" className="hp-mb-6">
                <Col>
                    <span
                        className="hp-d-block h5 hp-text-color-black-100 hp-text-color-dark-0 hp-mb-4">{item.title}</span>
            ...
            <Row align="middle" justify="space-between">
                <Col>
                    <a href="#" className="hp-d-flex-center hp-text-color-black-80 hp-text-color-dark-20">
                        ...
                        <span
                            className="hp-p1-body hp-text-color-black-80 hp-text-color-dark-20 hp-ml-6">View History</span>
                    </a>
                </Col>
