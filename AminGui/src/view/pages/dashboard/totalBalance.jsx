...
import SmallCardItem from "../../components/widgets/cards/advance/smallCardItem";
            ...
            <Row align="middle" justify="space-between" className="hp-mb-24">
                ...
                <Col>
                    <a href="#" className="hp-d-flex-center">
                        <span
                            className="hp-p1-body hp-text-color-black-80 hp-text-color-dark-20 hp-mr-4">View All</span>
