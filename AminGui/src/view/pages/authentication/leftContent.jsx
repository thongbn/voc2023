                ...
                <Col span={24}>
                    <Row align="middle" justify="center" className="hp-h-100">
                        <Col span={24} className="hp-bg-item hp-text-center hp-mb-md-32">
                            <img src={theme === "light" ? bg : bgDark} alt="Background Image" className="hp-w-100"/>
                        </Col>

                        <Col xl={18} span={24} className="hp-text-item hp-text-center">
                            <h2 className="hp-text-color-black-100 hp-text-color-dark-0 hp-mx-lg-16 hp-mb-16">Very good
